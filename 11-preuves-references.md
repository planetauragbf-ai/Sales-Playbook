...
## 11.1 Le réseau d'adhérents (preuve sociale par segment)

Notre réseau couvre **toutes les typologies de la cible**, dans toutes les régions viticoles. Exemples représentatifs de l'activité réelle (à utiliser par catégorie plutôt que par nom en premier contact) :

| Segment | Exemples du réseau | Usage en rendez-vous |
|---|---|---|
| Châteaux & domaines Rhône Sud | Château Fortia (Châteauneuf-du-Pape), Domaine du Pégau | « Des domaines de Châteauneuf expédient leurs allocations aux USA avec nous » |
| Provence | Château La Coste, Château de Sannes, Mas de Cadenet, Château Paradis, Domaine de Fontenille, Domaine Dalmeran, réseau Planet Provence | « La Provence est notre première région : les cars de touristes américains, on connaît » |
| Champagne | Champagne Gardet, Champagne La Maison Penet | « Nous gérons le certificat CIVC de maisons de Champagne à chaque envoi hors UE » |
| Cavistes & expériences urbaines | Les Caves du Louvre, O Château (Paris), Vino Sapiens, La Cave de la Madeleine, Caves Ambacia, Cave Arthus et Jean | « Les caves touristiques parisiennes transforment leurs dégustations en commandes livrées » |
| Nice / Bellet | Château de Bellet (e-shop connecté : ses commandes « shipping » nous parviennent automatiquement) | Preuve d'intégration e-commerce |
| Vallée du Rhône / Provence villages | Cassis Bodin, Domaine de la Vieille Cure, Château de Fontvert, Arthus et Jean | Maillage local = recommandations croisées |
...
### Cas 2 — Le champagne sans friction
« Une maison de Champagne adhérente vend à des clients de Géorgie, du Minnesota, du Texas. À chaque envoi : certificat CIVC demandé par nous, groupage DDP, suivi proactif. La maison n'a jamais rempli un document douanier. »

### Cas 3 — La casse bien gérée (le sinistre comme preuve)
« Une commande arrive endommagée aux USA. Le client signale sous 48 h, photos à l'appui. Résultat : **réexpédition complète organisée**, le domaine revend ses vins pour le remplacement, et le client final remercie par écrit — *"obviously this is quite unfortunate but not your fault, please reship"*. Un sinistre bien traité crée plus de fidélité qu'un transport parfait. »

### Cas 4 — Le stockage d'été
« En période de canicule, nous proposons aux clients finaux le **stockage gratuit d'été** : le vin acheté en juillet part en septembre-octobre. Les clients acceptent massivement — et certains, impatients ("Can I please have the wine shipped immediately"), choisissent en connaissance de cause. Le domaine n'a géré aucun de ces échanges : notre équipe l'a fait, en anglais. »
...
|---|---|
| Assurance jusqu'à **20 000 €/envoi** incluse | Documentation 2026 — à citer systématiquement |
| **36 bouteilles**/personne/envoi USA (6 L en spiritueux) | Grille 2026 |
| **48 h** France, **3-4 j** UE, **5 j** USA direct, **21 j** USA groupage | Grille 2026 (délais estimés) |
| **~50 États et destinations** tarifés en grille | Grille 2026 (UE + DOM + pays tiers + USA) |
| **Réseau multi-régions** : Provence, Rhône, Champagne, Bordeaux, Paris… | Portefeuille adhérents |
| Filiale **Planet Aura Inc. (USA)** + Branch Manager dédié | Organisation 2026 |
...
3. **Un bon de transport + DA anonymisés** — « voilà ce que nous éditons pour vous ».
4. **L'order form** — « voilà ce que remplit votre client au comptoir ».
